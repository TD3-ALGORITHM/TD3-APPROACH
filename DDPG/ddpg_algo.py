...
for i in range(MAX_EPISODES):
    ...
    while j < MAX_EP_STEPS:
        ...
        if offloading_ratio_change:
            a[3] = -1
        ddpg.store_transition(s_normal.state_normal(
        ...
        if j == MAX_EP_STEPS - 1 or is_terminal:
            ...
            workbook = xlsxwriter.Workbook("delay_episodes.xlsx")
...
# with open('ddpg_delay.txt', 'a') as file_obj:
#     file_obj.write("\ndelay:" + '{:2f}'.format(delay*10))
#     file_obj.write("\nepisodes:" + '{:2f}'.format(i))
